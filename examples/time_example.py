...
# 다음 이동할 장소의 종류 - 0: 여행 장소, 1: 맛집, 2:카페, 3:숙소
index = 0
...
#     global next_point, next_index, places_info
#
#     if place_info['index'] == 0 and index == 0:
#         # 여행 장소 -> 여행 장소
#
#         # 이동 시간
#         move_time = dists[current_point][next_point]
...
#         print(current_time, ':', places[current_point], '->', places[next_point])
#
#     elif place_info['index'] == 0 and index != 0:
#         # 여행 장소 -> (다른 장소)
#
#         # 추가할 장소
...
#
# while 1:
#     # 1 loop =  다음 장소로 이동 후 이동 시간 + 소요 시간까지 업데이트
#
